#ifndef _MESH_STATIC_AERO_H_
#define _MESH_STATIC_AERO_H_
...
namespace ae
{
	...
	class AERO_CORE_EXPORT MeshStatic : public TransformableDrawable3D
	{
	public:
		/// <summary>Cannot create an empty static mesh.</summary>
		MeshStatic() = delete;
		...
		explicit MeshStatic( const Uint32 _VerticesCount, const Uint32 _IndicesCount );
		...
		explicit MeshStatic( const Vertex3DArray& _Vertices, const IndexArray& _Indices );
		...
		explicit MeshStatic( const std::string& _FileName, Bool _UseTextureBool = False );
