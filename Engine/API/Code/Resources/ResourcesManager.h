...
namespace ae
{
	...
	public:
		...
		Material* GetDefaultFramebufferMaterial();
		...
		Material* GetDefaultSkyboxMaterial();
	...
	private:
		...
		Material* m_DefaultFramebufferMaterial;
