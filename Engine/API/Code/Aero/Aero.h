...
namespace ae
{
	...
	public :
        ...
        /// <summary>Update the current camera viewport according the the window size.</summary>
        /// <param name="_Window">The window to take the viewport data from.</param>
		void UpdateDefaultViewport( Window* _Window );
